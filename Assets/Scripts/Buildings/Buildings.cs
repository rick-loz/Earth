...
public abstract class Buildings : MonoBehaviour
{
    ...
    public abstract string getNewCapacity();

    public abstract string getNewMoneyIncome();


    public abstract string getNewWasteIncome();

    public abstract string getActiveMoneyCost();

    public abstract string getActiveWasteCost();
    ...
    public abstract string getActiveMoneyIncome();

    public abstract string getActiveWasteIncome();

    public abstract string getActiveCapacity();
